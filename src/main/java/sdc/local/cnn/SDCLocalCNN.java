...
//        secure(keyStoreLocation, keyStorePassword, null,null );
        ...
        File locationToSave = new File("neural_saves", "vgg16_dl4j_inference.zip");
        try
        {
...
//        System.out.println("dirPath: " + dirPath);
        ...
        File mainPath = new File("D:\\Screenshots/test");
        ...
        File netFile = new File("neural_saves", "vgg16_dl4j_inference.zip");
        if(netFile.exists())
        {
        	network = ModelSerializer.restoreComputationGraph(netFile);
        }
        else
        {
        	ZooModel zooModel = new VGG16();
        	network = (ComputationGraph) zooModel.initPretrained(PretrainedType.IMAGENET);
//	        switch (modelType) {
//	            case "LeNet":
//	                network = LeNet();
//	                break;
...
//            ModelSerializer.writeModel(network, new File("neural_saves", "sdclocalcnn.zip"), true);
