...
public abstract class ApiRequest<T> {
    ...
    public T execute() throws ApiException, ClientException {
    	//System.out.println("Cur counts " + callCount);
        ...
        for (int i = 0; i < retryAttempts; i++) {
            try {
            	...
            	if(callCount > 3) {
            		long dif = curTime - lastCallTime;
            		long timeToWait = 334 - dif;
            		//System.out.println("timeToWait " + timeToWait);
            		if(timeToWait < 1) timeToWait = 111;
            		
            		try {
            			//System.out.println("Sleep time = " + timeToWait);
                ...
                //System.out.println("Difference = " + ((curTime - 334) - lastCallTime));
                //if(callCount > 0 && curTime - 334 >= lastCallTime) {
                	//callCount--;
                //}
