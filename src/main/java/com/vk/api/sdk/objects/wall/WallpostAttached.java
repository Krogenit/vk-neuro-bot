...
public class WallpostAttached {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(toId, date, attachments, comments, postType, postSource, fromId, copyPostId, signerId, copyText, canDelete, id, text, copyOwnerId, reposts, likes);
    }
