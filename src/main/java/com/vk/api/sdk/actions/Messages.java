...
import com.vk.api.sdk.queries.messages.MessagesGetByConversationMessageId;
...
public class Messages extends AbstractAction {
    ...
    public MessagesGetByConversationMessageId getByConversationMessageId(GroupActor actor) {
    	return new MessagesGetByConversationMessageId(getClient(), actor);
    }
}
